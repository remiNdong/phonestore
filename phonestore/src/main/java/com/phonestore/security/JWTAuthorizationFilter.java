...
/*
 * Classe qui sera utilisée à chaque requete, un token sera fourni,
 * ce token permettra de remonter vers l'utilisateur et ses roles
 * et le contexte sera rechargé avec ces informations
 */
